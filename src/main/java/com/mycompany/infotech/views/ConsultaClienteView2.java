 ...
 * @author Icaro
 */
public class ConsultaClienteView2 extends javax.swing.JFrame {

    /**
     * Creates new form View_ConsultaClinente
     */
    public ConsultaClienteView2() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaClienteView2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaClienteView2().setVisible(true);
            }
        });
    }
