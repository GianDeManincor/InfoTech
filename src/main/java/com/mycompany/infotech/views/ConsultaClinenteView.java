 ...
 * @author Icaro
 */
public class ConsultaClinenteView extends javax.swing.JFrame {

    /**
     * Creates new form View_ConsultaClinente
     */
    public ConsultaClinenteView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaClinenteView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaClinenteView().setVisible(true);
            }
        });
    }
